const cityCode = require('../cityList');
 var weather  = require('../run/getWeather');
module.exports = {
    'POST /weather':async(ctx,next)=>{
        ...
        console.log('匹配的是',str1);
        console.log('城市的编码是:',cityCode[str1]);
        //查询天气
        console.log('地址',weather.f);
        weather.f= weather.f+cityCode[str1]+'.html';//不知道为什么原来的weather给const了,修改不了
        var value = await weather.req(weather.f);
        // setInterval();
        let weather1  = require('../run/getWeather');
